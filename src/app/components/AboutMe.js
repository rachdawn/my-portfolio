      ...
      >
        <Box sx={{ p: 1.5, width: { xs: "100%", md: "42%" } }}>
          ...
          >
            ...
            <br />
            NodeJS, ReactJS, Next.js, Ajax, Express, EJS, jQuery, Rails,
            Material UI
            <br />
        ...
        <Box sx={{ p: 1.5, width: { xs: "100%", md: "58%" } }}>
          ...
          >
            ...
            <br />
            <br />
            My training encompassed programming essentials such as JavaScript,
            CSS, and HTML, alongside in-depth studies in software architecture,
